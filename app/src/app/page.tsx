      ...
      <footer className="ll-footer">
        <div className="ll-con">
          <div className="ll-foot-socials">
            ...
            <a href="https://discord.gg/RA5Yv2gvjV" target="_blank" rel="noopener noreferrer" className="ll-social">
              <div className="ll-social-icon">
              ...
              <span className="ll-social-label">Discord</span>
            </a>
          </div>

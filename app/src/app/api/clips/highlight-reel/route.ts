    ...
    return NextResponse.json(
      {
        error: "limit_reached",
        message,
        // upgrade: true only for Free users. Pro users get upgrade: false
        // so callers show "wait until next month" instead of pushing to a
        // subscribe screen they don't need.

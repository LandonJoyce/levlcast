...
import { analyzeVod, analyzePublicPreview, rescueUnactivatedSignups, outreachHarvest, outreachDispatch, generateClip, cleanupStuckClips, cleanupStuckVods, cleanupOrphanedR2Objects, computeBurnoutScores, computeContentReports, compileWeeklyDigest, sendActivationNudge, sendStreakNudge, autoSyncTwitchVods, runWeeklyLeagues } from "@/lib/inngest/functions";
...
export const { GET, POST, PUT } = serve({
  client: inngest,
  functions: [analyzeVod, analyzePublicPreview, rescueUnactivatedSignups, outreachHarvest, outreachDispatch, generateClip, cleanupStuckClips, cleanupStuckVods, cleanupOrphanedR2Objects, computeBurnoutScores, computeContentReports, compileWeeklyDigest, sendActivationNudge, sendStreakNudge, autoSyncTwitchVods, runWeeklyLeagues],
});

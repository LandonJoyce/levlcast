...
/**
 * /v2: the homepage from 2026-09-17 to 2026-09-25, kept so it can be
 * compared or restored. Replaced at / by the post-match design (see
 * app/page.tsx). Out of search, so it never competes with the real one.
 *
 ...
 *
 * The design before this one is preserved at /v1.
 */

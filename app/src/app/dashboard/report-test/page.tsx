...
.rt-display{ font-family:"Instrument Serif", Georgia, serif; }
.rt-serif-i{ font-family:"Instrument Serif", Georgia, serif; font-style:italic; font-weight:400; }
.rt-label{
...
.rt-brand-name{ font-family:"Instrument Serif", Georgia, serif; font-size:19px; letter-spacing:0.18em; text-transform:uppercase; }
...
.rt-cover-title{
  font-family:"Instrument Serif", Georgia, serif; font-size:clamp(72px,9vw,148px);
...
.rt-cover-summary{
  font-family:"Instrument Serif", Georgia, serif; font-size:clamp(20px,1.9vw,26px);
...
.rt-scoreboard .big .n{
  font-family:"Instrument Serif", Georgia, serif; font-size:clamp(160px,18vw,260px);
...
.rt-mini .v{ font-family:"Instrument Serif", Georgia, serif; font-size:28px; line-height:1; color:var(--ink); }
...
.rt-vs-side .who{ font-family:"Instrument Serif", Georgia, serif; font-size:22px; line-height:1; text-transform:uppercase; }
...
.rt-vs-mid{ font-family:"Instrument Serif", Georgia, serif; font-style:italic; font-size:36px; color:var(--ink-2); line-height:1; }
...
.rt-obt::before{
  ...
  font-family:"Instrument Serif", Georgia, serif; font-size:78px; font-weight:500;
...
.rt-obt h2{ margin:0 0 14px; font-family:"Instrument Serif", Georgia, serif; font-size:32px; font-weight:500; text-transform:uppercase; letter-spacing:0.005em; }
.rt-obt h2 em{ font-family:"Instrument Serif", Georgia, serif; font-style:italic; font-weight:400; text-transform:none; color:var(--magenta); }
...
.rt-obt-stat .item .n{ font-family:"Instrument Serif", Georgia, serif; font-size:48px; line-height:1; color:var(--ink); }
...
.rt-section-head .title{ font-family:"Instrument Serif", Georgia, serif; font-size:26px; font-weight:400; line-height:1.1; margin:0; letter-spacing:-0.01em; color:#ECF1FA; }
.rt-section-head .title em{ font-family:"Instrument Serif", Georgia, serif; font-style:italic; font-weight:400; letter-spacing:-0.01em; }
...
.rt-col-head{ display:flex; align-items:center; justify-content:space-between; padding:14px 18px; border-bottom:1px solid var(--line); }
.rt-col-head h3{ margin:0; font-family:"Instrument Serif", Georgia, serif; font-size:22px; font-weight:400; letter-spacing:-0.01em; color:#ECF1FA; }
.rt-col-head h3 em{ font-family:"Instrument Serif", Georgia, serif; font-style:italic; font-weight:400; }
...
.rt-item{ display:grid; grid-template-columns:40px 1fr; gap:14px; padding:14px 18px; border-bottom:1px solid var(--line); }
.rt-item:last-of-type{ border-bottom:0; }
.rt-item .mark{ width:28px; height:28px; display:inline-flex; align-items:center; justify-content:center; border-radius:4px; font-family:"JetBrains Mono", monospace; font-size:14px; font-weight:700; margin-top:0; }
...
.rt-item h4{ margin:0 0 6px; font-family:system-ui, -apple-system, sans-serif; font-size:13px; font-weight:600; letter-spacing:0; display:flex; align-items:center; gap:10px; flex-wrap:wrap; }
.rt-item h4 .rt-pill{ font-size:9px; padding:3px 6px 2px; }
.rt-item p{ margin:0; color:#A6B3C9; font-size:12px; line-height:1.6; max-width:56ch; }
...
.rt-outgoing p{ margin:0; color:#A6B3C9; font-size:12px; line-height:1.6; max-width:60ch; }
...
.rt-callout::before{ content:"!"; position:absolute; left:28px; top:50%; transform:translateY(-50%); font-family:"Instrument Serif", Georgia, serif; font-size:52px; color:var(--amber); text-shadow:0 0 18px rgba(245,158,11,0.5); }
.rt-callout .rt-label{ color:var(--amber); margin-bottom:8px; display:block; }
.rt-callout h3{ margin:0 0 10px; font-family:"Instrument Serif", Georgia, serif; font-size:26px; font-weight:500; text-transform:uppercase; color:var(--amber); }
.rt-callout h3 em{ font-family:"Instrument Serif", Georgia, serif; font-style:italic; font-weight:400; text-transform:none; color:var(--ink); }
...
.rt-callout .streaks .s .n{ font-family:"Instrument Serif", Georgia, serif; font-size:32px; color:var(--ink); line-height:1; }
...
.rt-traj-head h3{ margin:0; font-family:"Instrument Serif", Georgia, serif; font-size:22px; font-weight:400; letter-spacing:-0.01em; color:#ECF1FA; }
.rt-traj-head h3 em{ font-family:"Instrument Serif", Georgia, serif; font-style:italic; font-weight:400; color:var(--magenta); }
...
.rt-chart{ position:relative; height:180px; display:grid; grid-template-columns:repeat(8,1fr); align-items:end; gap:14px; border-bottom:1px solid var(--line); padding-bottom:4px; }
...
.rt-bar-col .v{ position:absolute; top:-18px; font-family:"JetBrains Mono", monospace; font-size:11px; color:var(--ink-2); }
.rt-bar-col.current .v{ color:var(--magenta); font-size:13px; font-weight:600; }
...
.rt-tl-head h3{ margin:0; font-family:"Instrument Serif", Georgia, serif; font-size:22px; font-weight:400; letter-spacing:-0.01em; color:#ECF1FA; }
.rt-tl-head h3 em{ font-family:"Instrument Serif", Georgia, serif; font-style:italic; font-weight:400; color:var(--magenta); }
...
.rt-tl-track{ position:relative; height:88px; border:1px solid var(--line); background:linear-gradient(180deg, rgba(255,255,255,0.02), rgba(255,255,255,0)); border-radius:2px; overflow:hidden; }
...
.rt-tl-stats .v{ font-family:"Instrument Serif", Georgia, serif; font-size:20px; color:var(--ink); margin-top:4px; line-height:1; font-weight:400; }
...
.rt-urgent-mark .n{ font-family:"Instrument Serif", Georgia, serif; font-size:84px; color:var(--lime); line-height:0.9; text-shadow:0 0 18px rgba(163,230,53,0.4); font-weight:600; }
...
.rt-urgent-body h4{ font-family:"Instrument Serif", Georgia, serif; font-size:32px; font-weight:500; margin:0 0 14px; text-transform:uppercase; letter-spacing:0.005em; line-height:1; }
.rt-urgent-body h4 em{ font-family:"Instrument Serif", Georgia, serif; font-style:italic; font-weight:400; text-transform:none; color:var(--lime); }

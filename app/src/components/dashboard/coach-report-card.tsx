...
function ScoreRing({ score }: { score: number }) {
  ...
  return (
    <div className={`flex flex-col items-center justify-center w-20 h-20 rounded-full border-2 ${borderColor} bg-bg flex-shrink-0`}>
            ...
            {report.viewer_retention_risk && (
              <div className="mt-3 inline-flex items-center gap-1.5">
                <ShieldAlert size={12} className={
                  report.viewer_retention_risk === "low" ? "text-green-400" :

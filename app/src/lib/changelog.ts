...
export const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { type: "new", text: "Two minutes to rewatch on every report: one win and one lesson. Click the timestamp and your VOD opens at exactly that moment so you can study your own tape." },
    ],
  },
  {
    version: "v0.10.2",

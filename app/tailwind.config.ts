  ...
  theme: {
    extend: {
      colors: {
        ...
        "border-accent": "rgba(255, 88, 0, 0.25)",
      },
      fontFamily: {
      ...
      boxShadow: {
        glow: "0 0 40px rgba(255, 88, 0, 0.2)",
        "glow-lg": "0 0 80px rgba(255, 88, 0, 0.3)",
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px rgba(255, 88, 0, 0.3)" },
          "50%": { boxShadow: "0 0 40px rgba(255, 88, 0, 0.6)" },
        },
      },
      animation: {
